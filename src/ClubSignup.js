...
class ClubSignup extends React.Component
{
    ...
    submitForm = e => {
        e.preventDefault();
        const thatURL = getURL() + "club-signup/";
        console.log(thatURL);
            ...
            <>
                <div class="login-form">
                    ...
                    <form onSubmit={this.submitForm}>
                        ...
                        <input type="text" name="name" placeholder="Name" onChange={this.setInput} value={this.state.name}  required></input><br></br>
                        <input type="text" name="username" placeholder="Username" onChange={this.setInput} value={this.state.username}  required></input><br></br>
